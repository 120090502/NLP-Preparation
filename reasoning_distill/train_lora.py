...
BASE_LOG_DIR = "./logs"
DEFAULT_SPECIAL_TOKENS = ["<think>", "<answer>"]
...
def main():
    ...
    run_dir = create_run_directory(BASE_LOG_DIR)
    ...
    try:
        ...
        if new_tokens > 0:
            ...
            logger.info(f"Added {new_tokens} special tokens and resized embeddings")
        ...
        training_args = TrainingArguments(
            ...
            logging_dir=run_dir,  # Use run-specific directory for logging
        ...
        # Save final model
        ModelSaver.save(model, tokenizer, args.output_dir)
